...
trait ModelDecoders {
  ...
  implicit val partyIdCirceKeyDecoder: circe.KeyDecoder[Party.Id] = KeyDecoder.decodeKeyLong.map(Party.Id)

  implicit val motionIdCirceDecoder: circe.Decoder[Motion.Id] = Decoder.decodeLong.map(Motion.Id)
  implicit val motionIdCirceKeyDecoder: circe.KeyDecoder[Motion.Id] = KeyDecoder.decodeKeyLong.map(Motion.Id)
  ...
  implicit val politicianIdCirceKeyDecoder: circe.KeyDecoder[Politician.Id] = KeyDecoder.decodeKeyLong.map(Politician.Id)
  ...
  implicit val userIdCirceKeyDecoder: circe.KeyDecoder[User.Id] = KeyDecoder.decodeKeyLong.map(User.Id)
  ...
  implicit val ngoIdCirceKeyDecoder: circe.KeyDecoder[Ngo.Id] = KeyDecoder.decodeKeyLong.map(Ngo.Id)
